...
//     headless: false,
//     // Start with a clean user data directory
//     args: ['--no-first-run', '--disable-extensions']
//   });
  
//   // Create a new context (this automatically starts clean)
...
//   // Don't clear browser data here since there's no document yet
//   // The context is already clean when created
// });
